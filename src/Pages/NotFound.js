    ...
    return (
            <div className="h-screen w-full flex items-center justify-center bg-pattern bg-no-repeat bg-cover overflow-hidden">
                <div className='w-[400px] h-auto py-20 md:w-[500px] md:h-[600px] text-center bg-white rounded-lg overflow-hidden shadow-lg flex items-center justify-center flex-col space-y-7'>
                    ...
                    <Link to='/' className='bg-gradient-to-r from-violet-500 to-blue-500 py-4 px-5 hover: text-md text-white font-bold mt-12 rounded-md shadow-sm shadow-blue-500 hover:shadow-md hover:shadow-blue-500/40 transition-all duration-300 hover:-translate-y-2'>Go back to <span className='underlined'>RandomUserspage</span></Link>
                </div>
            </div>
    )
}
